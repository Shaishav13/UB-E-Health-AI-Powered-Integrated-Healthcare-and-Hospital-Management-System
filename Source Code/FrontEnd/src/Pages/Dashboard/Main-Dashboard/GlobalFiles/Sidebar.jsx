...
const Sidebar = () => {
  ...
  // Get total unread count from chat state (Req 11.6)
  ...
  return (
    <>
      ...
      <style>{`
        ...
        /* Unread badge on Messages nav item (Req 11.6) */
        .side-link-unread-badge {
          display: inline-flex;
          align-items: center;
              ...
              {user?.userType === "patient" && (
                <>
                  ...
                  >
                    ...
                    {totalUnreadCount > 0 && (
                      <span className="side-link-unread-badge" aria-label={`${totalUnreadCount} unread messages`}>
