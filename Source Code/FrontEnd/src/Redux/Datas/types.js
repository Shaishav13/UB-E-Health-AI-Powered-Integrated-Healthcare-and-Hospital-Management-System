...
export const GET_PATIENTS_BY_DOCTOR_SUCCESS = " GET_PATIENTS_BY_DOCTOR_SUCCESS";
export const GET_PATIENTS_BY_DOCTOR_ERROR = "GET_PATIENTS_BY_DOCTOR_ERROR";
export const GET_PATIENTS_BY_DOCTOR_REQUEST = "GET_PATIENTS_BY_DOCTOR_REQUEST";
